 ...
 * @data 2022/8/29
 */
public class Code03BinarySearchNearRight {

    public static int mostRightBinarySearch(int[] arr, int target) {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < testTimes; i++) {
            ...
            if (loopSearch(arr, target) != mostRightBinarySearch(arr, target)) {
